...
var startGame = function () {
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            // if player is still alive and we're not a the last enemy in the array
        ...
        // if player is not alive, break out of the lop and let endGame function run
        else {
            window.alert("You have lost your robot in battle! Game Over!");
            break;
        }
    }
    // after loop ends, we are either out of health or enemies to fight, so run the endGame function
    endGame();
};
